<aside id="default-sidebar" class=" md:w-2/5 lg:w-2/5 xl:w-1/5 bg-cyan-700 px-5 py-10 md:fixed md:top-0 md:left-0 md:h-full md:overflow-y-auto" aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 text-wrap">Costeo de Productos</span>
                    </a>
                </li>
